...
classifier.load_state_dict(torch.load('weights/wastenet.pth', map_location=device))
classifier.eval()
bgremover = model.U2NET()
bgremover.load_state_dict(torch.load('weights/u2net.pth', map_location=device))
bgremover.eval()
